(() => {
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".profile-user-project__slider")) new core(".profile-user-project__slider", {
            ...
            if (document.querySelector(".peoplle-page__slider")) new core(".peoplle-page__slider", {
        ...
        function closeMenuPros(e) {
            if (!e.target.closest(".menu__body") && e.target.closest(".menu-open")) functions_menuClose();
        }
